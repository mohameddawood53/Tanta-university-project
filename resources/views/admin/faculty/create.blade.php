...
@section('content')
    <div class="container">
        <h1 class="text-center p-5">إضافة كلية جديدة</h1>
        <div class="form-group">
            <form action="/faculties" method="post">

                @csrf
                <label for="name">الكلية</label>
                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="اسم الكلية">
                @error("name")
